                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvUsuario?accion=nuevo" class="btn btn-danger" style="width:100%">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_user" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Usuario</th>
                                                ...
                                                <td><a href="<c:url value="srvUsuario">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${user.estado == true}">
                                                            ...
                                                            <c:otherwise>
                                                            <input type="hidden" id="item" value="${user.id_usuario}">
                                                            <a id="activarUsuario" href="srvUsuario?cambiar=activar&cod=${user.id_usuario}" class="btn btn-success" data-toggle="tooltip" title="Activar" data-original-title="Activar">
