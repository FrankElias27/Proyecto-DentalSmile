                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="srvConsulta?accion=nuevo"><i class="fa fa-stethoscope"></i>Nueva Consulta</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nueva Consulta</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvConsulta?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;"> 
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <select class="form-control"  name="cboCita" autofocus=""  required="">
                                                ...
                                                <c:forEach items="${cita}" var="ci">
                                                    <option value="${ci.id_cita}"  
                                                            <c:if test="${ci.id_cita == 
                                                                          consulta.cita.id_cita}">
                                                                  selected
                                                            </c:if>
                                                            > Paciente: ${ci.paciente.nombre}.  Motivo: ${ci.descripcion}</option>
                                                </c:forEach>
                                            </select>
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa  fa-file-text"></i></span>
                                            <textarea  id="txtdescripcion" name="txtdiagnostico" rows="4" class="form-control" style="resize: none"></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-4 input-group">
                                            <a href="srvCita?accion=nuevo">
                                                <i>Desea Agendar una nueva cita al Paciente?</i>
                                            </a>
                                        </div>
                                    </div>
