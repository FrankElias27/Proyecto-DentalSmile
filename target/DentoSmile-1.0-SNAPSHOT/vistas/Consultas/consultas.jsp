                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvConsulta?accion=listarConsultas"><i class="fa fa-ambulance"></i>Administrar Consultas</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">    
                            <div class="box-header with-border">             
                                <h3 class="box-title">Mantenimiento de Consultas</h3>
                            </div>
                            <div class="box-body">
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvConsulta?accion=nuevo" class="btn btn-danger" style="width:100%">
                                    ...
                                    <table id="tabla_cita" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        ...
                                        <c:forEach var="co" items="${consulta}" varStatus="iteracion">                                                    
                                            <tr>
                                                ...
                                                <td>${co.cita.nombreo}</td>
                                                <td>${co.fecha}</td>
                                                <td>${co.diagnostico}</td>
                                                <c:if test="${co.estado == 'ATENDIDA'}">
                                                    <td><span class="badge bg-blue active">ATENDIDA</span></td> 
                                                </c:if>
                                                <c:if test="${co.estado== 'TERMINADA'}">
                                                    <td><span class="badge bg-purple active">TERMINADA</span></td> 
                                                </c:if>
                                                <td><a href="<c:url value="srvConsulta">
                                                           <c:param name="accion" value="leerConsulta" />
                                                    ...
                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${co.id_consulta}">
                                                    <a id="deleteConsul" href="<c:url value="srvConsulta">
                                                           <c:param name="accion" value="eliminarConsulta" />
                                                           <c:param name="cod" value="${co.id_consulta}" />
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="">Fecha Consulta</th>
                                                <th rowspan="1" colspan="1" style="">Di&aacute;gnostico</th>
