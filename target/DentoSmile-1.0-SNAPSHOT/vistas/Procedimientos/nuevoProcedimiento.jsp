                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Procedimiento</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvProcedimiento?accion=registrar" method="post" style="margin-right: 15px; margin-left: 15px;">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-folder"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Frenos dentales" name="txtNombre" maxlength="50"
                                                   value="">
                                        </div>
                                    </div>
