                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Procedimiento</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvProcedimiento?accion=actualizarProcedimiento" method="post" style="padding-right: 20px; padding-left: 20px">
                                <input type="hidden" name="hCodigo" value="${proce.id_procedimiento}">
                               <div class="box-body">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="chkEstadoIn" 
                                                           <c:out value="${proce.estado == 'ACTIVO' ?
                                                                           'checked':'unchecked'}"
                                                                  default="" />>Activo
                                                </label>
                                            </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvProcedimiento?accion=listarProcedimientos" class="btn btn-danger" style="text-align: right">
