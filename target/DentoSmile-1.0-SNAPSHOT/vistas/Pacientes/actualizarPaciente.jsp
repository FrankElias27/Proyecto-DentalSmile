                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Paciente</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvPaciente?accion=actualizarPaciente" method="post" style="padding-right: 20px; padding-left: 20px;">
                                <input type="hidden" name="hCodigo" value="${paciente.id_paciente}">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Av. Cutervo 226" name="txtDireccion" maxlength="50"
                                ...
                                <div class="box-footer">
                                    <a href="srvPaciente?accion=listarPacientes" class="btn btn-danger" style="text-align: right">
                                        <i class="fa fa-close red"></i> Cancelar</a>
                                        <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Paciente</button>
