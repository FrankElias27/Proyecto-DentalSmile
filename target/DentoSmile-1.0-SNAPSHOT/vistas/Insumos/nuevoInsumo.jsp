                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Insumo</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvInsumo?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Estado</label>                                       
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="minimal" name="chkEstadoIn" checked=""> Activo
                                                </label>
                                            </div>                                      
                                    </div>
                                </div>
