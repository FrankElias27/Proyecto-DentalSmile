                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvInsumo?accion=listarInsumos"><i class="fa fa fa-archive"></i>Insumos</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Insumo</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvInsumo?accion=actualizarInsumo" method="post" style="padding-right: 20px; padding-left: 20px;">
                                <input type="hidden" name="hCodigo" value="${insumo.id_insumo}">
                               <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Estado</label> 
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="chkEstadoIn" 
                                                           <c:out value="${insumo.estado == 'ACTIVO' ?
                                                                           'checked':'unchecked'}"
                                                                  default="" />>Activo
                                                </label>
                                            </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvInsumo?accion=listarInsumos" class="btn btn-danger" style="text-align: right">
