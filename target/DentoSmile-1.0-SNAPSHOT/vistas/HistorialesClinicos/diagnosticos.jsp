...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">    
                            <div class="box-header with-border">             
                                <h3 class="box-title">Di&aacute;gnosticos de las Citas</h3>
                            ...
                            <div class="box-body">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_cita" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        ...
                                        <c:forEach var="pa" items="${paciente1}" varStatus="iteracion">                                                    
                                            <tr>
                                                <td>${iteracion.index + 1}</td>
                                                <td>${pa.fecha1}</td>
                                                <td>${pa.odont1}</td>
                                                <td>${pa.descripcion1}</td>
                                                <td>${pa.diagnostico1}</td>
                                                <td>
                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigoFu" value="${pa.id_fua}">
                                                    <a id="deletFu" href="<c:url value="srvFua">
                                                           <c:param name="accion" value="eliminarFua" />
                                                           <c:param name="cod" value="${pa.id_fua}" />
                            ...
                            <a href="srvHistorial?accion=listarHistoriales" class="btn btn-danger" style="text-align: right">
                                        <i class="fa fa-close red"></i> Salir</a>
                                </div>
                        </div>
                    </div>
                </section>
        ...
        <script src="js/funcionesFua.js" type="text/javascript"></script>
        <script>
