                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="srvInsumo?accion=listarInsumos"><i class=" fa fa-archive"></i>Insumos</a></li>
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="srvHistorial?accion=nuevo"><i class="fa fa-file-text-o"></i>Nuevo Historial</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid" >  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Historial</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvHistorial?accion=registrar" method="post" style="padding-right: 20px; padding-left: 20px">
                                <div class="box-body">
                                     <div class="form-group">
                                        <label class="col-sm-8" style="text-align: center">Consultas disponibles para Registro:</label>
                                    </div>
                                    <div class="form-group"  >
                                        <label class="col-sm-2 control-label"></label>
                                        <div class="col-sm-4 input-group" style="padding-left: -20px">
                                            <div class="table-responsive">  
                                                <table id="tabla_cita" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                                    <thead>
                                                        <tr>
                                                            <th>#</th>
                                                            <th>Paciente </th>
                                                    ...
                                                    <c:forEach var="co" items="${consulta}" varStatus="iteracion">                                                    
                                                        <tr>
                                                            <td>${iteracion.index + 1}</td>
                                                            <td>${co.cita.nombrep}</td>
                                                            <td>${co.diagnostico}</td>

                                                            <td><a href="<c:url value="srvHistorial">
                                                                       <c:param name="accion" value="leer" />
                                                                       <c:param name="cod1" value="${co.id_consulta}" />
                                                                   </c:url>"><button type="button" class="btn btn-primary" data-toggle="tooltip"  title="Buscar" data-original-title="Buscar">
                                                                        <i class="glyphicon glyphicon-search"></i></button></a>
                                ...
                                <input type="hidden" name="txtidConsulta" value="${consul.id_consulta}">
                                <input type="hidden" name="txtidHistorial" value="${consul.id_historia}">
                                    <div class="form-group">
                                        <label class="col-sm-8 control-label" style="text-align: center">Detalles del Historial:</label>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <textarea  id="txtdescripcion" name="txtmotivoHI" rows="4" class="form-control" style="resize: none">${consul.cita.descripcion}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa  fa-file-text"></i></span>
                                            <textarea  id="txtdescripcion" name="txtdescripcionHI" rows="4" class="form-control" style="resize: none">${consul.descripcion}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvHistorial?accion=listarHistoriales" class="btn btn-danger" style="text-align: right">
