...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">    
                            <div class="box-header with-border">             
                                <h3 class="box-title">Mantenimiento de Odontólogos</h3>
                            </div>
                            <div class="box-body">
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvOdontologo?accion=nuevo" class="btn btn-danger" style="width:100%">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_odontologo" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nro DNI</th>
                                        ...
                                        <c:forEach var="odont" items="${odontologos}" varStatus="iteracion">                                                    
                                            <tr>
                                                <td>${iteracion.index + 1}</td>
                                                <td>${odont.dni}</td>
                                                <td>${odont.nombre}</td>
                                                <td>${odont.sexo}</td>
                                                <td>${odont.telefono}</td>
                                                <td>${odont.usuario.nombreUsuario}</td>
                                                <td><a href="<c:url value="srvOdontologo">
                                                           <c:param name="accion" value="leerOdontologo" />
                                                           <c:param name="cod1" value="${odont.id_doctor}" />
                                                       </c:url>"><button type="button" class="btn btn-primary" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                            <i class="fa fa-edit"></i></button></a>

                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${odont.id_doctor}">
                                                    <a id="deleteOdont" href="<c:url value="srvOdontologo">
                                                           <c:param name="accion" value="eliminarOdontologo" />
                                                           <c:param name="cod" value="${odont.id_doctor}" />
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="">Odontólogo</th>
        ...
        <script src="js/funcionesOdontologo.js" type="text/javascript"></script>
        <script>
