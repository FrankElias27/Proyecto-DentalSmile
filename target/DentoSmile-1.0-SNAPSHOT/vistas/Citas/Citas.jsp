...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvCita?accion=listarCitas"><i class="fa fa-ambulance"></i>Administrar Citas</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvCita?accion=nuevo" class="btn btn-danger" style="width:100%">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_cita" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        ...
                                        <c:forEach var="ci" items="${citas}" varStatus="iteracion">                                                    
                                            <tr>
                                                <td>${iteracion.index + 1}</td>
                                                <td>${ci.fecha}</td>
                                                <td>${ci.hora}</td>
                                                <td>${ci.paciente.nombre}</td>
                                                <td>${ci.odontologo.nombre}</td>
                                                <c:if test="${ci.estadocita.nombreEstado == 'RESERVADA'}">
                                                    <td><span class="badge bg-yellow active">RESERVADA</span></td> 
                                                </c:if>
                                                <c:if test="${ci.estadocita.nombreEstado == 'CONFIRMADA'}">
                                                    <td><span class="badge bg-green active">CONFIRMADA</span></td> 
                                                </c:if>
                                                <c:if test="${ci.estadocita.nombreEstado == 'ANULADA'}">
                                                    <td><span class="badge bg-red active">ANULADA</span></td> 
                                                </c:if>
                                                <c:if test="${ci.estadocita.nombreEstado == 'ATENDIDA'}">
                                                    <td><span class="badge bg-blue active">ATENDIDA</span></td> 
                                                </c:if>
                                                <c:if test="${ci.estadocita.nombreEstado == 'TERMINADA'}">
                                                    <td><span class="badge bg-purple active">TERMINADA</span></td> 
                                                </c:if>
                                                <c:if test="${ci.estadocita.nombreEstado == 'REPROGRAMADA'}">
                                                    <td><span class="badge bg-yellow active">REPROGRAMADA</span></td> 
                                                </c:if>    
                                                <td>${ci.descripcion}</td>
                                                <td><a href="<c:url value="srvCita">
                                                           <c:param name="accion" value="leerCita" />
                                                           <c:param name="cod1" value="${ci.id_cita}" />
                                                       </c:url>"><button type="button" class="btn btn-primary" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                            <i class="fa fa-edit"></i></button></a>

                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${ci.id_cita}">
                                                    <a id="deleteCita" href="<c:url value="srvCita">
                                                           <c:param name="accion" value="eliminarCita" />
                                                           <c:param name="cod" value="${ci.id_cita}" />
                                        ...
                                        <tfoot>
                                            <tr>
                                                <th rowspan="1" colspan="1">Nro Atención</th>
                                                <th rowspan="1" colspan="1" style="">Fecha</th>
                                                <th rowspan="1" colspan="1" style="">Hora</th>
                                                <th rowspan="1" colspan="1" style="">Paciente</th>
                                                <th rowspan="1" colspan="1" style="">Odont&oacute;logo</th>
                                                <th rowspan="1" colspan="1" style="">Estado</th>
                                                <th rowspan="1" colspan="1" style="">Motivo</th>
        ...
        <script src="js/funcionesCita.js" type="text/javascript"></script>
        <script>
