...
public class DAOUSUARIO extends Conexion {
    ...
    public List<usuario> listarUsuarios() throws Exception {
        ...
        usuario usu;
        ResultSet rs = null;
        String sql = "SELECT U.IDUSUARIO, U.NOMBREUSUARIO, U.CLAVE, U.EMAIL, U.ESTADO, C.NOMBRECARGO "
    ...
    public void registrarUsuarios(usuario usu) throws Exception {
        String sql;
        sql = "INSERT INTO Usuario (NOMBREUSUARIO, CLAVE, EMAIL, ESTADO, IDCARGO) "
    ...
    public usuario leerUsuario(usuario usu) throws Exception {
        usuario usus = null;
        ResultSet rs = null;
        String sql = "SELECT U.IDUSUARIO, U.NOMBREUSUARIO, U.CLAVE, U.EMAIL, U.ESTADO, U.IDCARGO "
