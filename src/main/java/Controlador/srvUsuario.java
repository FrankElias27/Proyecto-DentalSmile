...
public class srvUsuario extends HttpServlet {
    ...
    private void verificar(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        } else if (usuario != null && usuario.getCargo().getNombreCargo().equals("ODONTOLOGO")) {
            sesion = request.getSession();
            sesion.setAttribute("odontologo", usuario);
            this.getServletConfig().getServletContext().getRequestDispatcher("/vistas/VistaOdontologo.jsp").forward(request, response);
        } else {
