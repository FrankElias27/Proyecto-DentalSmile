                ...
                <section class="content">
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            ...
                            <br>
                            <form class="form-horizontal" action="srvUsuario?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;>
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Usuario</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Alexis" name="txtNombre" maxlength="10"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Estado</label>                                       
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="minimal" name="chkEstado" checked=""> Activo
                                                </label>
                                            </div>                                      
                                    </div>
                                </div>
