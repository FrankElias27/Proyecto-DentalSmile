...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvHistorial?accion=listarHistoriales"><i class="fa fa-ambulance"></i>Administrar Historial</a></li>
                            </ul>
                        </li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">    
                            <div class="box-header with-border">             
                                <h3 class="box-title">Mantenimiento de Historiales Cl&iacute;nicos</h3>
                            </div>
                            <div class="box-body">
                                <br>
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvHistorial?accion=nuevo" class="btn btn-danger" style="width:100%">
                                    ...
                                    <table id="tabla_cita" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Nro Documento</th>
                                                <th>Paciente</th>
                                                <th>Di&aacute;gnosticos</th>
                                                <th>Acciones</th> 
                                            </tr>
                                        </thead>
                                        <c:forEach var="hi" items="${historial}" varStatus="iteracion">                                                    
                                            <tr>
                                                <td>${iteracion.index + 1}</td>
                                                <td>${hi.fecharegistro}</td>
                                                <td>${hi.paciente.dni}</td>
                                                <td>${hi.paciente.nombre}</td>
                                                <td>
                                                    <a href="<c:url value="srvFua">
                                                           <c:param name="accion" value="listarDiagnosticos" />
                                                           <c:param name="cod1" value="${hi.paciente.id_paciente}" />
                                                ...
                                                <td>
                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${hi.id_historial}">
                                                    <a id="deletHi" href="<c:url value="srvHistorial">
                                                           <c:param name="accion" value="eliminarHistorial" />
                                                           <c:param name="cod" value="${hi.id_historial}" />
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="">Fecha Registro</th>
                                                <th rowspan="1" colspan="1" style="">Nro Documento</th>
                                                <th rowspan="1" colspan="1" style="">Paciente</th>
                                                <th rowspan="1" colspan="1" style="">Di&aacute;gnosticos</th>
        ...
        <script src="js/funcionesHistorial.js" type="text/javascript"></script>
        <script>
