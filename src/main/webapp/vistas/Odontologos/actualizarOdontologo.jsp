                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvOdontologo?accion=listarOdontologos"><i class=" fa fa-user-md"></i>Odontólogos</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Odont&oacute;logo</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvOdontologo?accion=actualizarOdontologo" method="post" style="padding-right: 20px; padding-left: 20px;">
                                <input type="hidden" name="hCodigo" value="${doctor.id_doctor}">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Alexander" name="txtNombre" maxlength="50"
                                                   value="${doctor.nombre}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Alexander" name="txtApellido" maxlength="50"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <select class="form-control"  name="cboSexo" autofocus=""  required="">
                                                <option value="${doctor.sexo}">${doctor.sexo}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Alexander" name="txtTele" maxlength="9"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="date" class="form-control" placeholder="Ejem: Alexander" name="txtDate"
                                                   value="${doctor.fechanac}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Alexander" name="txtDni" maxlength="8"
                                                   value="${doctor.dni}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <select class="form-control"  name="cboUsuario" autofocus=""  required="">
                                                <option value="0">Seleccione el usuario correspondiente</option>
                                                <c:forEach items="${usuarios}" var="usus">
                                                    <option value="${usus.id_usuario}"  
                                                            <c:if test="${usus.id_usuario == 
                                                                          doctor.usuario.id_usuario}">
                                                                  selected
                                                            </c:if>
                                                            >${usus.nombreUsuario}</option>
                                                </c:forEach>
                                            </select>
                                        </div>                                  
                                    </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvOdontologo?accion=listarOdontologos" class="btn btn-danger" style="text-align: right">
                                        <i class="fa fa-close red"></i> Cancelar</a>
                                        <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Odont&oacute;logo</button>
