                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Odont&oacute;logo</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvOdontologo?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;>
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Alexis" name="txtNombre" maxlength="50"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Lopez Rivera" name="txtApellido" maxlength="50"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: 958124365" name="txtTele" maxlength="9"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: 78945863" name="txtDni" maxlength="8"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
