                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="srvCita?accion=nuevo"><i class="fa fa-hospital-o"></i>Nueva Cita</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nueva  Cita</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvCita?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa  fa-file-text"></i></span>
                                             <textarea  id="txtdescripcion" name="txtdescripcion" rows="4" class="form-control" style="resize: none"></textarea>
                                        </div>
                                    </div>
                                </div>
