                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Cita</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvCita?accion=actualizarCita" method="post" style="padding-right: 20px; padding-left: 20px;">
                                <input type="hidden" name="hCodigo" value="${cita.id_cita}">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Paciente</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-heartbeat"></i></span>
                                            <select class="form-control"  name="cboPaciente" autofocus=""  required="">
                                                <option value="0">Seleccione el paciente</option>
                                                <c:forEach items="${pacientes}" var="pac">
                                                    <option value="${pac.id_paciente}"  
                                                            <c:if test="${pac.id_paciente == 
                                                                          cita.paciente.id_paciente}">
                                                                  selected
                                                            </c:if>
                                                            >${pac.nombre} ${pac.apellidos}</option>
                                                </c:forEach>
                                            </select>
                                        </div>                                  
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Odontólogo</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user-md"></i></span>
                                            <select class="form-control"  name="cboOdontologo" autofocus=""  required="">
                                                <option value="0">Seleccione el Odontólogo</option>
                                                <c:forEach items="${odontologos}" var="odo">
                                                    <option value="${odo.id_doctor}"  
                                                            <c:if test="${odo.id_doctor == 
                                                                          cita.odontologo.id_doctor}">
                                                                  selected
                                                            </c:if>
                                                            >${odo.nombre} ${odo.apellidos}</option>
                                                </c:forEach>
                                            </select>
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="time" class="form-control" placeholder="Ejem: Alexander" name="txtTime"
                                                   value="${cita.hora}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <select class="form-control"  name="cboEstado" autofocus=""  required="">
                                                <option value="${cita.estadocita.id_estado}" selected >${cita.estadocita.nombreEstado}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-file-text"></i></span>
                                             <textarea  id="txtdescripcion" name="txtdescripcion" rows="4" class="form-control" style="resize: none">${cita.descripcion}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvCita?accion=listarCitas" class="btn btn-danger" style="text-align: right">
                                        <i class="fa fa-close red"></i> Cancelar</a>
                                    <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Cita</button>
