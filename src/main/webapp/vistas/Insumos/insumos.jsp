...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvInsumo?accion=nuevo" class="btn btn-danger" style="width:100%">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_insumo" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        ...
                                        <c:forEach var="in" items="${insumo}" varStatus="iteracion">                                                    
                                            <tr>
                                                <td>${iteracion.index + 1}</td>
                                                <td>${in.nombre}</td>
                                                <td>${in.stock}</td>
                                                <td>${in.fecregis}</td>
                                                <c:if test="${in.estado == 'ACTIVO'}">
                                                    <td><span class="badge bg-green active">ACTIVO</span></td> 
                                                </c:if>
                                                <c:if test="${in.estado == 'INACTIVO'}">
                                                    <td><span class="badge bg-red active">INACTIVO</span></td> 
                                                </c:if>
                                                <td><a href="<c:url value="srvInsumo">
                                                           <c:param name="accion" value="leerInsumo" />
                                                           <c:param name="cod1" value="${in.id_insumo}" />
                                                       </c:url>"><button type="button" class="btn btn-primary" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                            <i class="fa fa-edit"></i></button></a>

                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${in.id_insumo}">
                                                    <a id="deleteIn" href="<c:url value="srvInsumo">
                                                           <c:param name="accion" value="eliminarInsumo" />
                                                           <c:param name="cod" value="${in.id_insumo}" />
        ...
        <script src="js/funcionesInsumo.js" type="text/javascript"></script>
        <script>
