                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Consulta</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvConsulta?accion=actualizarConsulta" method="post" style="padding-right: 20px; padding-left: 20px;">
                                <input type="hidden" name="hCodigo" value="${consulta.id_consulta}">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Cita</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-hospital-o"></i></span>
                                            <select class="form-control"  name="cboCita" autofocus=""  required="">
                                                <option value="0">Seleccione la cita</option>
                                                <option selected > Paciente: ${consulta.cita.nombrep}. Motivo: ${consulta.cita.descripcion}</option>
                                            </select>
                                        </div>                                  
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa  fa-file-text"></i></span>
                                             <textarea  id="txtdescripcion" name="txtdescripcion" rows="4" class="form-control" style="resize: none">${consulta.descripcion}</textarea>
                                        </div>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Di&aacute;gnostico</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa  fa-file-text"></i></span>
                                             <textarea  id="txtdescripcion" name="txtdiagnostico" rows="4" class="form-control" style="resize: none">${consulta.diagnostico}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvConsulta?accion=listarConsultas" class="btn btn-danger" style="text-align: right">
