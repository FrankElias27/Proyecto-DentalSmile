...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                <li class="active"><a href="srvProcedimiento?accion=listarProcedimientos"><i class="fa fa-folder"></i>Procedimientos</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="srvHistorial?accion=nuevo"><i class="fa fa-stethoscope"></i>Nueva Consulta</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="srvCita?accion=nuevo"><i class="fa fa-file-text-o"></i>Nuevo Historial</a></li>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvProcedimiento?accion=nuevo" class="btn btn-danger" style="width:100%">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_insumo" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nombre</th>
                                        ...
                                        <c:forEach var="pro" items="${procedimiento}" varStatus="iteracion">                                                    
                                            <tr>
                                                <td>${iteracion.index + 1}</td>
                                                <td>${pro.nombre}</td>
                                                <td>${pro.fecregis}</td>
                                                <c:if test="${pro.estado == 'ACTIVO'}">
                                                    <td><span class="badge bg-green active">ACTIVO</span></td> 
                                                </c:if>
                                                <c:if test="${pro.estado == 'INACTIVO'}">
                                                    <td><span class="badge bg-red active">INACTIVO</span></td> 
                                                </c:if>
                                                <td><a href="<c:url value="srvProcedimiento">
                                                           <c:param name="accion" value="leerProcedimiento" />
                                                           <c:param name="cod1" value="${pro.id_procedimiento}" />
                                                       </c:url>"><button type="button" class="btn btn-primary" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                            <i class="fa fa-edit"></i></button></a>

                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${pro.id_procedimiento}">
                                                    <a id="deletePro" href="<c:url value="srvProcedimiento">
                                                           <c:param name="accion" value="eliminarProcedimiento" />
                                                           <c:param name="cod" value="${pro.id_procedimiento}" />
        ...
        <script src="js/funcionesProcedimiento.js" type="text/javascript"></script>
        <script>
