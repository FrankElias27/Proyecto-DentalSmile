                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Paciente</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvPaciente?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;>
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Cristian" name="txtNombre" maxlength="50"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Torres Cuadros" name="txtApellido" maxlength="50"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: 945865512" name="txtTele" maxlength="9"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: 78936145" name="txtDni" maxlength="8"
                                                   value="">
                                        </div>
                                    </div>
                                     <div class="form-group">
