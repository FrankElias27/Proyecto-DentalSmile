                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Registrar Nuevo Medicamento</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvMedicamento?accion=registrar" method="post" style="margin-right: 20px; margin-left: 20px;>
                                <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-medkit"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Penicilina" name="txtNombre" maxlength="50"
                                                   value="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Estado</label>                                       
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" class="minimal" name="chkEstadoMe" checked=""> Activo
                                                </label>
                                            </div>                                      
                                    </div>
                                </div>
