...
<html>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-2">
                                        ...
                                        <a href="srvMedicamento?accion=nuevo" class="btn btn-danger" style="width:100%">
                                ...
                                <div class="table-responsive" >  
                                    <table id="tabla_medicamento" class="table table-striped display responsive nowrap dataTable dtr-inline collapsed " style="width: 100%;" role="grid">
                                        <thead>
                                            <tr>
                                                <th>#</th>
                                                <th>Nombre</th>
                                        ...
                                        <c:forEach var="me" items="${medicamento}" varStatus="iteracion">                                                    
                                            <tr>
                                                ...
                                                <td>${me.stock}</td>
                                                <td>${me.fecvenc}</td>
                                                <c:if test="${me.estado == 'ACTIVO'}">
                                                    <td><span class="badge bg-green active">ACTIVO</span></td> 
                                                </c:if>
                                                <c:if test="${me.estado == 'INACTIVO'}">
                                                    <td><span class="badge bg-red active">INACTIVO</span></td> 
                                                </c:if>
                                                <td><a href="<c:url value="srvMedicamento">
                                                           <c:param name="accion" value="leerMedicamento" />
                                                           <c:param name="cod1" value="${me.id_medicamento}" />
                                                       </c:url>"><button type="button" class="btn btn-primary" data-toggle="tooltip"  title="Editar" data-original-title="Editar">
                                                            <i class="fa fa-edit"></i></button></a>

                                                    <!-- ELIMINAR USUARIOS -->
                                                    <input type="hidden" id="codigo" value="${me.id_medicamento}">
                                                    <a id="deleteMe" href="<c:url value="srvMedicamento">
                                                           <c:param name="accion" value="eliminarMedicamento" />
                                                           <c:param name="cod" value="${me.id_medicamento}" />
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th rowspan="1" colspan="1" style="">Alias</th>
                                                <th rowspan="1" colspan="1" style="">Stock</th>
                                                <th rowspan="1" colspan="1" style="">Fecha de Vencimiento</th>
        ...
        <script src="js/funcionesMedicamento.js" type="text/javascript"></script>
        <script>
