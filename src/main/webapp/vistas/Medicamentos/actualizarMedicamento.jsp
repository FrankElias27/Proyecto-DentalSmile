                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview active">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="active"><a href="srvMedicamento?accion=listarMedicamentos"><i class="fa fa-medkit"></i>Medicamentos</a></li>
                    ...
                    <div class="col-md-12">
                        <div class="box box-warning box-solid">  
                            <div class="box-header with-border">
                                <i class="fa fa-edit"></i> <h3 class="box-title">Actualizar Datos Medicamento</h3>
                            </div>
                            <br>
                            <form class="form-horizontal" action="srvMedicamento?accion=actualizarMedicamento" method="post" style="padding-right: 20px; padding-left: 20px;">
                                <input type="hidden" name="hCodigo" value="${medicamento.id_medicamento}">
                               <div class="box-body">
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Nombre</label>
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-medkit"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Pinzas" name="txtNombre" maxlength="50"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            <span class="input-group-addon"><i class="fa fa-medkit"></i></span>
                                            <input id="nombre" type="text" class="form-control" placeholder="Ejem: Peni" name="txtAlias" maxlength="50"
                                                   value="${medicamento.alias}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="nombre" type="date" class="form-control" placeholder="Ejem: " name="txtDate"
                                                   value="${medicamento.fecvenc}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 input-group">
                                            ...
                                            <input id="stock" type="text" class="form-control" placeholder="Ejem: #120" name="txtStock" maxlength="50"
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label">Estado</label> 
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="chkEstadoMe" 
                                                           <c:out value="${medicamento.estado == 'ACTIVO' ?
                                                                           'checked':'unchecked'}"
                                                                  default="" />>Activo
                                                </label>
                                            </div>
                                ...
                                <div class="box-footer">
                                    <a href="srvMedicamento?accion=listarMedicamentos" class="btn btn-danger" style="text-align: right">
                                        <i class="fa fa-close red"></i> Cancelar</a>
                                        <button type="submit" id="" name="btnRegistrar" value="Registrar" class="btn btn-success"><i class="fa fa-refresh"></i> Actualizar Insumo</button>
